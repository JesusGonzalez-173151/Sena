...
class CustomCircleBarDrawable : Drawable {
    ...
    var finanza = ArrayList<Finanza>()

    constructor(context: Context, finanza: ArrayList<Finanza>){
    ...
    override fun draw(p0: Canvas){
        ...
        /*if(finanza.size !=0){
            for (e in finanza){
                val degree: Double = (e.porcentaje*360)/100
                this.anguloBarrido = degree.toFloat()
